...
},{"bootstrap":"node_modules/bootstrap/dist/js/bootstrap.esm.js","./index.js":"index.js"}],"script.js":[function(require,module,exports) {
"use strict";
...
function _getBreedData() {
  _getBreedData = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var breed_id, response, data, h1, temprament, p, str, h4, ul;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          Carousel.clear();
